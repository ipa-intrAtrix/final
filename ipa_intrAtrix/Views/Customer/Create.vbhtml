...
@Using Html.BeginForm()
    ...
    @<div>
        @*<div class="form-group">
            ...
            @Html.ValidationMessageFor(Function(model) model.CustId, Nothing, New With {.class = "help-inline"})
        </div>*@
        ...
        <div class="form-group">
            ...
            @Html.ValidationMessageFor(Function(model) model.Waranty.WarantyDescr, Nothing, New With {.class = "help-inline"})
        </div>
        ...
        <p>
            ...
            <input type="submit" value="Kundennetzwerk erfassen" class="btn btn-primary" />
        </p>
    </div>
End Using
